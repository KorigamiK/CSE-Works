        ...
        \begin{table}[!ht]
            ...
            \begin{tabular}[h]{p{1.38cm}p{1.85cm}p{0.75cm}p{0.35cm}p{0.65cm}p{0.95cm}p{0.2cm}p{0.2cm}p{0.2cm}p{0.2cm}p{0.2cm}p{0.2cm}}
                ...
                \footnotesize{Material}
                 ...
                 & \multicolumn{2}{c}\footnotesize{Bandgap(ev)}
                 & \footnotesize{Direct / Indirect}
                 & \multicolumn{2}{c}\footnotesize{ $\kappa(Wm^{-1}k^{-1})$}
                 & \multicolumn{2}{c}\footnotesize{$\sigma_e(\times10^{-3}Scm^-1)$}
                 & \multicolumn{2}{c}\footnotesize{ZT($10^{-4}$)}                                                                                     \\
                \hline\hline

                \multirow{4}{4em}{\footnotesize{\footnotesize{xxx}}}
                 & \multirow{4}{4em}{\footnotesize{\footnotesize{xxx}}}
                 & \multirow{4}{4em}{\footnotesize{xxxxxx}}
                 & \footnotesize{YYYY}                                              & \footnotesize{XXXX}
                 & \multirow{4}{4em}{\footnotesize{Direct}}
                 ...
                 &                                                                  &                     & \footnotesize{XXX}  & \footnotesize{exp,}
                 &                                                                  & \footnotesize{ZZ}   & \footnotesize{exp,}
                 & \footnotesize{YY}                                                & \footnotesize{exp,}
                 & \footnotesize{XX}                                                & \footnotesize{exp,}                                             \\
